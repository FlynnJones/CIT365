...
namespace Math_Quiz
{
    public partial class Form1 : Form
    {
        ...
        // Store numbers for the addition problem
        int addend1;
        int addend2;    
        ...
        // Store the numbers for the division problem
        int dividend;
        int divisor; 
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                // Set background color to red at 5 seconds left
                if (timeLeft == 6)  
                {
        ...
        // The answer_Enter functions convert the user's answers into integers
        ...
        //ring bell if addition is correct
